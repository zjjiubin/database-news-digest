...
- 生成时间：2026-05-21 05:07:27 UTC
- 跟踪渠道：arXiv cs.DB、PVLDB、PACMMOD、ICDE、CIDR、DBLP
- 本次纳入论文：78 篇
- 来源分布：arXiv cs.DB 27 篇；PVLDB 22 篇；PACMMOD 17 篇；CIDR 6 篇；ICDE 6 篇
...
- [DBAIOps: A Reasoning LLM-Enhanced Database Operation and Maintenance System using Knowledge Graphs](https://www.vldb.org/pvldb/vol19/p1319-zhou.pdf)
  ...
  为什么重要：有系统实现，有实验评估，贴近真实场景
  摘要判断：这篇工作主要落在 存储引擎。更偏系统实现。
- [FPGA-Accelerated Lock Management and Transaction Processing: Architecture, Optimization, and Design Space Exploration](https://arxiv.org/pdf/2605.13398v1.pdf)
  来源：arXiv cs.DB | 日期：2026-05-13 | 评分：17 | 作者：Shien Zhu, Gustavo Alonso
