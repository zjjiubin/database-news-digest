...
- 生成时间：2026-08-06 04:08:15 UTC
- 跟踪渠道：arXiv cs.DB、PVLDB、PACMMOD、ICDE、CIDR、DBLP
- 本次纳入论文：69 篇
- 来源分布：arXiv cs.DB 29 篇；PVLDB 19 篇；PACMMOD 15 篇；CIDR 6 篇
...
5. [Join Indices for Search Engines: a Prunable Parallel Semijoin over Lucene Segments](https://arxiv.org/pdf/2608.01173v1.pdf)
   - 来源：arXiv cs.DB | 日期：2026-08-02 | 评分：23 | 分类：存储引擎、查询优化
   - 为什么值得看：有系统实现，有原型实现，带基准测试，关注吞吐
   - 摘要判断：这篇工作主要落在 存储引擎、查询优化。更偏系统实现。
6. [TEngineDB-V: An OLAP-Native Vector Search System for Large-$k$ Workloads at Tencent](https://arxiv.org/pdf/2608.00650v1.pdf)
   - 来源：arXiv cs.DB | 日期：2026-08-01 | 评分：22 | 分类：查询优化、OLAP / 分析执行
   - 为什么值得看：有系统实现，带生产环境信号，关注延迟，涉及代价模型
   - 摘要判断：这篇工作主要落在 查询优化、OLAP / 分析执行。更偏系统实现。
7. [How to Write to SSDs](https://www.vldb.org/pvldb/vol19/p1469-lee.pdf)
   - 来源：PVLDB | 日期：2026-03-01 | 评分：21 | 分类：存储引擎、OLAP / 分析执行
   - 为什么值得看：有系统实现，带基准测试，关注吞吐
   - 摘要判断：这篇工作主要落在 存储引擎、OLAP / 分析执行。更偏系统实现。
8. [LakeHelm: Zero-Shot Lakehouse Advisor for Joint Engine-Format Selection and Configuration](https://www.vldb.org/pvldb/vol19/p1768-xu.pdf)
...
- [O3-LSM: Maximizing Disaggregated LSM Write Performance via Three-Layer Offloading](https://dl.acm.org/doi/pdf/10.1145/3802093)
  ...
  摘要判断：这篇工作主要落在 存储引擎、查询优化。摘要里有较强实验评估信号。
- [Join Indices for Search Engines: a Prunable Parallel Semijoin over Lucene Segments](https://arxiv.org/pdf/2608.01173v1.pdf)
  来源：arXiv cs.DB | 日期：2026-08-02 | 评分：23 | 作者：Mikhail Khludnev
...
- [How to Write to SSDs](https://www.vldb.org/pvldb/vol19/p1469-lee.pdf)
  ...
  摘要判断：这篇工作主要落在 存储引擎、OLAP / 分析执行。更偏系统实现。
- [Two-sided RDMA Striking Back for Disaggregated Memory Databaases](https://arxiv.org/pdf/2607.26227v1.pdf)
  来源：arXiv cs.DB | 日期：2026-07-28 | 评分：19 | 作者：Hokeun Cha, Aditya Akella, Xiangyao Yu
  为什么重要：有系统实现，带基准测试，关注吞吐，关注延迟
...
- [DBA-Bench: A Production-Fidelity Benchmark for LLM-Based Database Operations Agents](https://arxiv.org/pdf/2607.22165v1.pdf)
  来源：arXiv cs.DB | 日期：2026-07-24 | 评分：17 | 作者：Junming Chen, Junyang Jiang, Xu Chen, Zibo Liang
...
- [Join Indices for Search Engines: a Prunable Parallel Semijoin over Lucene Segments](https://arxiv.org/pdf/2608.01173v1.pdf)
  ...
  为什么重要：有系统实现，有原型实现，带基准测试，关注吞吐
  摘要判断：这篇工作主要落在 存储引擎、查询优化。更偏系统实现。
- [TEngineDB-V: An OLAP-Native Vector Search System for Large-$k$ Workloads at Tencent](https://arxiv.org/pdf/2608.00650v1.pdf)
  来源：arXiv cs.DB | 日期：2026-08-01 | 评分：22 | 作者：Xufei Wu, Pengcheng Zhang, Yitong Song, Xiaobo Zhang
  为什么重要：有系统实现，带生产环境信号，关注延迟，涉及代价模型
  摘要判断：这篇工作主要落在 查询优化、OLAP / 分析执行。更偏系统实现。
