...
- 生成时间：2026-04-23 04:11:17 UTC
- 跟踪渠道：arXiv cs.DB、PVLDB、PACMMOD、ICDE、CIDR、DBLP
- 本次纳入论文：79 篇
- 来源分布：arXiv cs.DB 37 篇；PVLDB 19 篇；PACMMOD 17 篇；ICDE 6 篇
...
7. [RELOAD: A Robust and Efficient Learned Query Optimizer for Database Systems](https://arxiv.org/pdf/2604.14725v1.pdf)
   ...
   - 摘要判断：这篇工作主要落在 查询优化、OLAP / 分析执行。更偏系统实现。
8. [Worst-Case Optimal GPU Datalog](https://arxiv.org/pdf/2604.20073v1.pdf)
...
- [RELOAD: A Robust and Efficient Learned Query Optimizer for Database Systems](https://arxiv.org/pdf/2604.14725v1.pdf)
  ...
  摘要判断：这篇工作主要落在 查询优化、OLAP / 分析执行。更偏系统实现。
- [Worst-Case Optimal GPU Datalog](https://arxiv.org/pdf/2604.20073v1.pdf)
