...
6. [Robust Predicate Transfer with Dynamic Execution](https://www.vldb.org/pvldb/vol19/p1278-qiao.pdf)
...
- [Terark-DS: A High-Performance and Storage-Efficient Key-Value Separation Storage Engine on Disaggregated Storage](https://www.vldb.org/pvldb/vol19/p822-zhang.pdf)
  ...
  摘要判断：这篇工作主要落在 存储引擎。更偏系统实现。
- [A Pragmatic Approach to Learned Indexing in RocksDB: Targeted Optimizations with Minimal System Modification](https://arxiv.org/pdf/2605.23815v1.pdf)
  来源：arXiv cs.DB | 日期：2026-05-22 | 评分：18 | 作者：Shubham Vashisth, Olivier Michaud, Bettina Kemme, Oana Balmau
  为什么重要：有系统实现，有原型实现，带生产环境信号，关注吞吐
  摘要判断：这篇工作主要落在 存储引擎。更偏系统实现。
...
- [Agentic Cost-Aware Query Planning with Knowledge Distillation for Big Data Analytics](https://arxiv.org/pdf/2605.17831v1.pdf)
  来源：arXiv cs.DB | 日期：2026-05-18 | 评分：19 | 作者：Mahdi Naser-Moghadasi
