...
- 生成时间：2026-05-07 04:32:21 UTC
- 跟踪渠道：arXiv cs.DB、PVLDB、PACMMOD、ICDE、CIDR、DBLP
- 本次纳入论文：84 篇
- 来源分布：arXiv cs.DB 32 篇；PVLDB 23 篇；PACMMOD 17 篇；CIDR 6 篇；ICDE 6 篇
...
5. [Scaling Worst-Case Optimal Datalog to GPUs](https://arxiv.org/pdf/2604.20073v2.pdf)
   - 来源：arXiv cs.DB | 日期：2026-04-22 | 评分：20 | 分类：查询优化、OLAP / 分析执行
   - 为什么值得看：有系统实现，贴近真实场景，带生产环境信号，涉及连接处理
   - 摘要判断：这篇工作主要落在 查询优化、OLAP / 分析执行。更偏系统实现。
6. [Index-Assisted Stratified Sampling for Online Aggregation](https://arxiv.org/pdf/2604.28141v1.pdf)
...
- [Spark Policy Toolkit: Semantic Contracts and Scalable Execution for Policy Learning in Spark](https://arxiv.org/pdf/2604.25061v1.pdf)
  ...
  摘要判断：这篇工作主要落在 OLAP / 分析执行。更偏系统实现。
- [A Hierarchical Agent System with Reinforcement Learning for Multivariate Time Series Data Cleaning](https://arxiv.org/pdf/2605.04902v1.pdf)
  来源：arXiv cs.DB | 日期：2026-05-06 | 评分：17 | 作者：Yuhan Shi, Yuanyuan Yao, Lu Chen, Mourad Khayati
  为什么重要：有系统实现，贴近真实场景，涉及连接处理
  摘要判断：这篇工作主要落在 查询优化、OLAP / 分析执行。更偏系统实现。
