...
- 生成时间：2026-03-25 22:33:18 CST
- 跟踪渠道：arXiv cs.DB、PVLDB、PACMMOD、ICDE、CIDR、DBLP
- 本次纳入论文：76 篇
- 来源分布：arXiv cs.DB 31 篇；PACMMOD 20 篇；PVLDB 19 篇；ICDE 6 篇

## 本期最值得优先阅读

1. [GPU Acceleration of SQL Analytics on Compressed Data](https://www.vldb.org/pvldb/volumes/19/contributions)
...
- [GPU Acceleration of SQL Analytics on Compressed Data](https://www.vldb.org/pvldb/volumes/19/contributions)
