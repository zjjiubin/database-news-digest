...
- 生成时间：2026-07-09 04:49:09 UTC
- 跟踪渠道：arXiv cs.DB、PVLDB、PACMMOD、ICDE、CIDR、DBLP
- 本次纳入论文：84 篇
- 来源分布：arXiv cs.DB 41 篇；PVLDB 22 篇；PACMMOD 15 篇；CIDR 6 篇
...
6. [Experience Graphs: The Data Foundation for Self-Improving Agents](https://arxiv.org/pdf/2606.29823v1.pdf)
   - 来源：arXiv cs.DB | 日期：2026-06-29 | 评分：20 | 分类：存储引擎、查询优化、OLAP / 分析执行
   - 为什么值得看：有系统实现，带生产环境信号
   - 摘要判断：这篇工作主要落在 存储引擎、查询优化、OLAP / 分析执行。更偏系统实现。
7. [From Single to Multiple Attributes: Experimental Insights on Sampling-Based Distinct Combination Estimation in GROUP-BY Queries](https://arxiv.org/pdf/2607.00868v1.pdf)
   - 来源：arXiv cs.DB | 日期：2026-07-01 | 评分：20 | 分类：查询优化、OLAP / 分析执行
   - 为什么值得看：带基准测试，有实验评估，贴近真实场景，涉及基数估计
   - 摘要判断：这篇工作主要落在 查询优化、OLAP / 分析执行。摘要里有较强实验评估信号。
...
- [O3-LSM: Maximizing Disaggregated LSM Write Performance via Three-Layer Offloading](https://dl.acm.org/doi/pdf/10.1145/3802093)
  ...
  摘要判断：这篇工作主要落在 存储引擎、查询优化。摘要里有较强实验评估信号。
- [Experience Graphs: The Data Foundation for Self-Improving Agents](https://arxiv.org/pdf/2606.29823v1.pdf)
  来源：arXiv cs.DB | 日期：2026-06-29 | 评分：20 | 作者：Gang Liao, Yujia He, Abdullah Ozturk, Zhouyang Li
  为什么重要：有系统实现，带生产环境信号
  摘要判断：这篇工作主要落在 存储引擎、查询优化、OLAP / 分析执行。更偏系统实现。
...
- [BtrLog: Low-Latency Logging for Cloud Database Systems](https://arxiv.org/pdf/2606.27051v2.pdf)
  来源：arXiv cs.DB | 日期：2026-06-25 | 评分：16 | 作者：Maximilian Kuschewski, Lam-Duy Nguyen, Matthias Jasny, Tobias Ziegler
...
- [MUFASA: Fast and Accurate Multivariate Time-Series Clustering](https://dl.acm.org/doi/pdf/10.1145/3802090)
  ...
  摘要判断：这篇工作主要落在 查询优化、OLAP / 分析执行。摘要里有较强实验评估信号。
- [Exploiting Structural Properties for Efficient Constraint-Aware HNSW Hyperparameter Tuning](https://arxiv.org/pdf/2607.04630v1.pdf)
  来源：arXiv cs.DB | 日期：2026-07-06 | 评分：19 | 作者：Geon Choi, Hoeun Lee, Jaeyoung Do
