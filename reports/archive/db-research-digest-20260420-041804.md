...
- [Optimizing Relational Queries over Array-Valued Data in Columnar Systems](https://arxiv.org/pdf/2604.01967v1.pdf)
  来源：arXiv cs.DB | 日期：2026-04-02 | 评分：17 | 作者：Maroua Zeblah, Etienne Couritas, Sarah Chlyah, Pierre Genevès
  为什么重要：有系统实现，贴近真实场景，涉及连接处理
  摘要判断：这篇工作主要落在 查询优化、OLAP / 分析执行。更偏系统实现。
