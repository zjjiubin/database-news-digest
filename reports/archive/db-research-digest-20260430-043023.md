...
- 生成时间：2026-04-30 04:30:23 UTC
- 跟踪渠道：arXiv cs.DB、PVLDB、PACMMOD、ICDE、CIDR、DBLP
- 本次纳入论文：77 篇
- 来源分布：arXiv cs.DB 35 篇；PVLDB 19 篇；PACMMOD 17 篇；ICDE 6 篇
...
3. [Heuristic Search Space Partitioning for Low-Latency Multi-Tenant Cloud Queries](https://arxiv.org/pdf/2604.19057v1.pdf)
   - 来源：arXiv cs.DB | 日期：2026-04-21 | 评分：21 | 分类：查询优化
   - 为什么值得看：有系统实现，有实验评估，带生产环境信号，关注吞吐
...
6. [RELOAD: A Robust and Efficient Learned Query Optimizer for Database Systems](https://arxiv.org/pdf/2604.14725v1.pdf)
   - 来源：arXiv cs.DB | 日期：2026-04-16 | 评分：20 | 分类：查询优化、OLAP / 分析执行
   - 为什么值得看：有系统实现，带基准测试，带生产环境信号，涉及连接处理
   - 摘要判断：这篇工作主要落在 查询优化、OLAP / 分析执行。更偏系统实现。
7. [Scaling Worst-Case Optimal Datalog to GPUs](https://arxiv.org/pdf/2604.20073v2.pdf)
   - 来源：arXiv cs.DB | 日期：2026-04-22 | 评分：20 | 分类：查询优化、OLAP / 分析执行
   - 为什么值得看：有系统实现，贴近真实场景，带生产环境信号，涉及连接处理
   - 摘要判断：这篇工作主要落在 查询优化、OLAP / 分析执行。更偏系统实现。
...
- [LIVE: Learnable Monotonic Vertex Embedding for Efficient Exact Subgraph Matching (Technical Report)](https://arxiv.org/pdf/2604.19116v1.pdf)
  来源：arXiv cs.DB | 日期：2026-04-21 | 评分：19 | 作者：Yutong Ye, Weilong Ren, Yang Liu, Mengyi Yan
  为什么重要：贴近真实场景，涉及代价模型
  摘要判断：这篇工作主要落在 存储引擎、查询优化、OLAP / 分析执行。和真实业务或生产环境关联较强。
...
- [LiveBin: A Localized and Version-Aware Binned Scan Index](https://dl.acm.org/doi/pdf/10.1145/3786664)
  ...
  为什么重要：有系统实现，有实验评估
  摘要判断：这篇工作主要落在 存储引擎、OLAP / 分析执行。更偏系统实现。
- [BranchBench: Aligning Database Branching with Agentic Demands](https://arxiv.org/pdf/2604.17180v1.pdf)
  来源：arXiv cs.DB | 日期：2026-04-19 | 评分：18 | 作者：Elaine Ang, Sam Weldon, In Keun Kim, Kevin Durand
...
- [Heuristic Search Space Partitioning for Low-Latency Multi-Tenant Cloud Queries](https://arxiv.org/pdf/2604.19057v1.pdf)
  来源：arXiv cs.DB | 日期：2026-04-21 | 评分：21 | 作者：Prashant Kumar Pathak, Chandra Biksheswaran Mouleeswaran, Rama Teja Repaka
  为什么重要：有系统实现，有实验评估，带生产环境信号，关注吞吐
  摘要判断：这篇工作主要落在 查询优化。更偏系统实现。
- [Meerkat: Scalable, Network-Aware Failure Recovery for the Internet of Things](https://www.vldb.org/pvldb/vol19/p306-kozar.pdf)
  来源：PVLDB | 日期：2025-11-01 | 评分：20 | 作者：Anastasiia Kozar, Ankit Chaudhary, Steffen Zeuch, Volker Markl
  为什么重要：关注吞吐，关注延迟，涉及连接处理
  摘要判断：这篇工作主要落在 存储引擎、查询优化。建议先看问题定义和实验设置。
- [RELOAD: A Robust and Efficient Learned Query Optimizer for Database Systems](https://arxiv.org/pdf/2604.14725v1.pdf)
  来源：arXiv cs.DB | 日期：2026-04-16 | 评分：20 | 作者：Seokwon Lee, Jaeyoung Sim, Sihyun Kim, Yuhsing Li
  为什么重要：有系统实现，带基准测试，带生产环境信号，涉及连接处理
  摘要判断：这篇工作主要落在 查询优化、OLAP / 分析执行。更偏系统实现。
- [Scaling Worst-Case Optimal Datalog to GPUs](https://arxiv.org/pdf/2604.20073v2.pdf)
  来源：arXiv cs.DB | 日期：2026-04-22 | 评分：20 | 作者：Yihao Sun, Kunting Qi, Thomas Gilray, Sidharth Kumar
  为什么重要：有系统实现，贴近真实场景，带生产环境信号，涉及连接处理
  摘要判断：这篇工作主要落在 查询优化、OLAP / 分析执行。更偏系统实现。
- [Efficient Methods for Accurate Sparse Trajectory Recovery and Map Matching.](https://arxiv.org/pdf/2508.10460)
  来源：ICDE | 日期：2025-05-19 | 评分：19 | 作者：Wei Tian, Jieming Shi 0001, Man Lung Yiu
  为什么重要：有系统实现，有实验评估，贴近真实场景
...
- [IndicDB -- Benchmarking Multilingual Text-to-SQL Capabilities in Indian Languages](https://arxiv.org/pdf/2604.13686v1.pdf)
  来源：arXiv cs.DB | 日期：2026-04-15 | 评分：17 | 作者：Aviral Dawar, Roshan Karanth, Vikram Goyal, Dhruv Kumar
  为什么重要：带基准测试，贴近真实场景，涉及连接处理
